...
function EditAppointment(props) {
  ...
  useEffect(() => {
    ...
    function getappointment() {
      ...
      axios.get(`https://dogycare-backend-ssd.onrender.com/appointment/${params.id}`).then((res) => {
  ...
  function sendData(e) {
    ...
    axios.put(`https://dogycare-backend-ssd.onrender.com/appointment/${params.id}`, newAppointment).then(() => {
